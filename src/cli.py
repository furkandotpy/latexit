import argparse
from . import latexify as _latexify
import sys
import os
import tempfile
...
def main():
    ...
    try:
        _latexify(args.latex_code, args.output_path, dpi=args.dpi, fontsize=args.fontsize, padding=args.padding)
        ...
        # This is a best-effort: in most cases, the log is in the tempdir used by latexify
